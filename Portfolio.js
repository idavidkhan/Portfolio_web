...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const testimonials = [
    {
      quote:
        "Working with Ubaid has been an excellent experience. He has a real talent for simplifying complex DevSecOps processes into clear, actionable steps that everyone can follow. His expertise in cloud and DevOps has often been my go-to resource, and what sets him apart is his patience and willingness to share knowledge. Ubaid not only solves problems but also helps elevate the entire team’s skills.",
      author: "Umair Amjad",
    ...
    {
      quote:
        "Ubaid’s approach to building and maintaining reliable systems impressed us from the very beginning. He implemented a robust monitoring and alerting setup that gave us full visibility into our applications, resulting in improved performance and stability. Beyond his technical depth, he communicates clearly and works well with others, which makes collaboration easy. Ubaid is a true professional we’d be more than happy to work with again.",
      author: "Zaheer Abbas",
    ...
    {
      quote:
        "Ubaid consistently delivers beyond expectations and has been a key asset to our projects. He automated our deployment pipelines, reducing release times from hours to just minutes, which had a huge impact on productivity. What stands out is his calmness under pressure and ability to collaborate seamlessly across teams. Ubaid combines technical excellence with professionalism, making him a truly reliable and standout DevOps engineer.",
      author: "Hamdan Ahmad",
